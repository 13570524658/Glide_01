...
import com.example.glide_01.App
import java.io.File
...
class GlideConfigModule : AppGlideModule() {
    ...
    //磁盘缓存外部存储大小
    private val diskCacheSize = 100 * 1024 * 1024L

    //缓存大小
    private val memoryCacheSize = 100 * 1024 * 1024L

    //Bitmap池大小
    private val bitmapPoolSize = 100 * 1024 * 1024L
    ...
    //磁盘缓存外部存储的绝对路径
    private  var path: String ="/GlideImage"
